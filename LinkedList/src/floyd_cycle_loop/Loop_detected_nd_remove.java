package floyd_cycle_loop;

public class Loop_detected_nd_remove 
{
	
	 private Node head;
	 Loop_detected_nd_remove()
	 {
	  head = null;
	 }
	 static class Node
	 ...
	 {
		 Loop_detected_nd_remove list = new Loop_detected_nd_remove();
		 
		 Node node = new Node(30);
		 	list.insertLast(new Node(12));
		  	list.insertLast(new Node(23));
		  	list.insertLast(new Node(63));
		  	list.insertLast(new Node(10));
		  	list.insertLast(new Node(20));
		  	list.insertLast(node);
	  	
		  	list.insertLast(new Node(49));
